# Checklist chất lượng đặc tả: Màn hình danh sách giao dịch

**Mục đích**: Kiểm tra tính đầy đủ và chất lượng của đặc tả trước khi lập kế hoạch
**Ngày tạo**: 2026-09-05
**PBI**: 9 — [Liên kết tới spec.md](./spec.md)
...
- [x] Phạm vi rõ ràng (đã chốt: hiển thị + điểm vào; card tháng dương lịch gồm ví ẩn; cuộn toàn bộ không điều hướng tháng)
