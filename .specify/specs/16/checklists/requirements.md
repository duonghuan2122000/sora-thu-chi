# Checklist chất lượng đặc tả: Sắp xếp danh mục

**Mục đích**: Kiểm tra tính đầy đủ và chất lượng của đặc tả trước khi lập kế hoạch
**Ngày tạo**: 2026-09-06
**PBI**: 16 — [Liên kết tới spec.md](../spec.md)
...
- Hai quyết định mở về phạm vi đã chốt với người dùng: (1) chỉ sắp danh mục cha cấp 1 — khớp mockup `04`, sắp con theo nhóm để PBI sau; (2) danh mục ẩn vẫn hiện trong màn sắp xếp. Các điểm khác (màn vào theo tab đang mở, ghi nhận thứ tự ngay khi thả) ghi trong mục "Giả định".
