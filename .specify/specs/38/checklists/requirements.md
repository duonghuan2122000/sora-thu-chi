# Checklist chất lượng đặc tả: Cập nhật giao diện màn Thêm giao dịch

**Mục đích**: Kiểm tra tính đầy đủ và chất lượng của đặc tả trước khi lập kế hoạch
**Ngày tạo**: 2026-09-17
**PBI**: 38 — [spec.md](../spec.md)
...
2 điểm cần làm rõ đã hỏi và chốt trong hội thoại (không đưa vào spec dạng [CẦN LÀM RÕ]):
- Phạm vi: chỉ cập nhật UI màn Thêm giao dịch, **không** xây luồng "Sửa giao dịch" (chốt 1A).
- Cách nhập Tag: màn chọn tag riêng (danh sách + tạo mới tại chỗ), không phải hộp thoại gõ tự do (chốt 2B).
