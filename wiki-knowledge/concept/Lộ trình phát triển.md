...
- **Tiện ích & Cá nhân hóa — màn danh sách `01` đã triển khai (PBI 17)** — điểm vào Cài đặt nhóm KHÁC → "Tiện ích & Cá nhân hóa" (chi tiết tại [[Hồ sơ & Bảo mật]]): 3 nhóm/8 hàng mockup; **2 công tắc thật** (Ẩn số dư tắt, Máy tính bật) nhớ trạng thái bằng bảng drift key-value **`AppSettings` schema v5**; hàng Widget = switch câm + dialog hướng dẫn ghim (không lưu); 5 hàng điều hướng no-op. Còn lại (PBI sau): màn con `02`–`07` (giao diện, ngôn ngữ, định dạng & tiền tệ, máy tính, tìm kiếm toàn cục, quản lý tag), **hiệu ứng công tắc** (che số dư thật, đổi bàn phím nhập tiền), dark mode cho màn này, tablet.
...
7. **Nhóm Tiện ích & Cá nhân hóa (§12)**: màn danh sách `01` (gom điểm vào) **đã MVP (PBI 17)**; còn **màn con `02`–`07`** (Light/Dark mode, đa ngôn ngữ, định dạng ngày/tiền/kỳ tài chính, máy tính, tìm kiếm, tag) và **hiệu ứng 2 công tắc** — chưa gắn GĐ. Riêng đa ngôn ngữ: cơ chế chốt **GetX Translations** ([[Stack kỹ thuật]]), cần chốt luôn danh sách ngôn ngữ hỗ trợ.
