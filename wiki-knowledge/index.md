...
- [[Báo cáo]] — **màn `01` Tổng quan (PBI 22)**: kỳ Ngày/Tuần/Tháng/Năm (tuần bắt đầu Thứ Hai), 6 đơn vị trên biểu đồ, gộp danh mục cha + nhóm "Khác", top 5, drill-down sang màn Giao dịch đã lọc, bảng màu định tính **không coral**; không schema riêng, không cache
...
- [[Lộ trình phát triển]] — MVP/GĐ2/GĐ3, phụ thuộc module, **quyết định mở** (nhóm Tiện ích: `01`–`03` đã xong; ngân sách: 2c đóng ở mức tối thiểu — PBI 21; báo cáo: màn `01` xong — PBI 22)
- [[Stack kỹ thuật]] — drift, GetX (state + i18n Translations đã thi công PBI 19), fl_chart (**đã dùng thật PBI 21/22: `BarChart` + `PieChart`**), notifications, secure storage, local_auth
- [[Design system]] — màu teal/coral, app shell FAB, typography, component, **token light/dark** (ThemeExtension `SoraColors`), biểu đồ ngân sách + **bảng màu định tính `chartPalette`** cho vòng tròn báo cáo
